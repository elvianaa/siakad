    ...
    <form method="post" action="#" class="mt-4">
        <table class="table table-borderless" style="width:500px;">
            ...
            <tr><td>Jenis Kelamin</td><td>
                    <input type="radio" name="jk" value="M" id="jkM" <?php if(@$jk=="M") echo "checked"; ?>>
                    <label for="jkM">Laki-laki</label>
                    <input type="radio" name="jk" value="F" id="jkF" <?php if(@$jk=="F") echo "checked"; ?>>
                    <label for="jkF">Perempuan</label>
                </td></tr>
