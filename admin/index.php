...
<html lang="en">
  ...
  <head>
    ...
    <title>Siakad UIN SAIZU | via</title>
    ...
    <meta name="title" content="Siakad UIN SAIZU | via" />
    <meta name="author" content="ColorlibHQ" />
    <meta
      name="description"
      content="Siakad UIN SAIZU is a Free Bootstrap 5 Admin Dashboard, 30 example pages using Vanilla JS. Fully accessible with WCAG 2.1 AA compliance."
    />
    <meta
      name="keywords"
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Elviana</span>
              </a>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="./?p=ganti_password" class="nav-link">
                  <i class="nav-icon bi bi-circle-fill"></i>
                  <p>Ganti Password</p>
                </a>
              </li>
